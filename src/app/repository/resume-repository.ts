...
import { RootReducerState, getResume, getResumeById, resumeError, resumeLoaded, resumeLoading } from "../reducers";
import { 
  AddAwardAction,
...
export class ResumeRepository {
  ...
  saveResume(data: { name: string; }): Observable<any> {
